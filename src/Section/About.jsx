        ...
        <div className="about__grid">
          ...
          <div className="about__content">
            <p>
              ...
              I enjoy transforming ideas into products, whether it’s a store
              website or a Kotlin mobile app connected to a MySQL database.
            </p>
            ...
            <ul className="about__bullets">
              ...
              <li>Hands-on experience with PHP, JavaScript, Kotlin & MySQL.</li>
            </ul>

            <p>
              My approach is simple: <em>clean, maintainable code</em>, a focus
              on
              <em> accessibility and performance</em>, and clear communication.
              I iterate quickly, ship reliably, and stay current with tools and
              best practices so the solutions I build keep working long after
              launch.
            </p>
